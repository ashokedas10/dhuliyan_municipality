...
// Accounts Sections
 ...
 GeneralServices.factory('Sale_test',['$http','$rootScope',function($http,$rootScope)
 {
	...
	// $rootScope.jsontest=[];
	// var data_link=domain_name+'employees.json';					
	// console.log('url : '+data_link);					
	// $http.get(data_link).then(function(response){
	// 	angular.forEach(response.data,function(value,key){
	// 		$scope.savemsg=value.name; 
	// 		$rootScope.jsontest.push({name: value.name,city:value.city,state:value.state});
	// 		console.log($scope.savemsg);
	// 	});
	// });

	// console.log($rootScope.jsontest);
