...
<html lang="en">
  <head>
    ...
    <title>Dhuliyan Municipality | ধুলিয়ান পৌরসভা</title>
  ...
  <body style="background-image:url('img/gplay.png');">
    <!-- Page loader -->
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-2 col-sm-4 col-xs-4 text-center">
            ...
            <div class="owl-carousel owl-theme dhuliyan">
              <div class="item">Dhuliyan Municipality</div>
              <div class="item">ধুলিয়ান পৌরসভা</div>
            </div>
          </div>
          <div class="col-md-10 col-sm-8 col-xs-8">
            <div class="info pull-right">
              <ul class="list-unstyled">
                <li>
                  <p><img src="img/icon/gmail.svg" class="icon"> dhuliyanmunicipality@gmail.com <br />  &nbsp; &nbsp; &nbsp;&nbsp; info@dhuliyanmunicipality.in</p>
                </li>
              </ul>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            ...
            <li id="administrtor"><a href="administrator.php">Administrtor</a></li>
            <li id="tender" ><a href="tender.php">Tender</a></li>
