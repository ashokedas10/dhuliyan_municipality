	...
	<div class="body-left">
	  ...
	  <div class="body-right">
			<div class="testimonials">
				<h2>  <span class="red-txt">Recruitment notice 2019</span></h2>
				<h4><span class="red-txt"><a href="<?php echo BASE_PATH_FRONT?>APPLICATION_FORMAT.pdf">Download Application Format
				</a></span></h4>
				<h4><span class="red-txt"><a href="<?php echo BASE_PATH_FRONT?>Employment_Notice.pdf">Download Employment Notice</a></span></h4>					
