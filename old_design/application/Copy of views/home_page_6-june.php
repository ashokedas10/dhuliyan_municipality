...
<? $sqlproduct="SELECT * FROM  `product` WHERE  `brand_id` ='35' ORDER BY  `product`.`id` DESC "; 
...
<!--SAMSUNG PRODUCTS-->
<div class="featuredInner">
<? $sqlproduct="SELECT * FROM `product` WHERE `brand_id`='43' ORDER BY  `product`.`id` DESC "; 
$productlist = $this->projectmodel->get_records_from_sql($sqlproduct);?>
<?php
...
<!--Laptops-->
<div class="featuredInner">
<? $sqlproduct="SELECT * FROM  `product` WHERE  `brand_id` =64 ORDER BY  `product`.`id` DESC"; 
$productlist = $this->projectmodel->get_records_from_sql($sqlproduct);?>
<?php
...
$brandlist = $this->projectmodel->get_records_from_sql($sqlbrand);?>
	...
	?>
    <li class="als-item"><a href="<?php echo BASE_URL?>cmscontaint/product_list_brand/brand/<? echo $row_brand->id;?>"><img src="<?php echo $picpath.$row_brand->images; ?>" alt="<?php echo $row_brand->brand_name; ?>"  width="73" height="56" /></a> </li>
	<?php } ?>
	</ul>
  </div>
