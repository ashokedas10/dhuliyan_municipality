...
///////////////////////////////////////////starts Som Nath  10-june/////////////////////////////////////////////////////////////////////////
	public function save_records_model_admin($id,$table_name,$tabale_data)
	{
		if($id>0)
		{
			$this->db->update($table_name, $tabale_data, array('a_id' => $id));
		}
		else
		{
			$this->db->insert($table_name,$tabale_data);
	...
	public function get_all_record_admin($table_name,$where_array)
	{
		$res=$this->db->get_where($table_name,$where_array);
		return $res->result();
	}	
	public function delete_record_admin($id=0,$table_name)
	{
		$this->db->delete($table_name,array('a_id'=>$id));
	}	
///////////////////////////////////////////starts Som Nath  10-june/////////////////////////////////////////////////////////////////////////
}
?>