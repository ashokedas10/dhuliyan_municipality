...
<script type="text/javascript">
	...
	function validateStep1(){
       ...
       if( ! pattern.test(un)){
         isValid = false;
         $('#msg_username').html('Please fill a valid email').show();
       }else{
       ...
       if(! pattern.test(mob)){
         isValid = false;
         $('#msg_mobile').html('Please fill mobile no').show();
       }else{
    ...
    function validateStep2(){
       ...
       if(!name && name.length <= 0){
         isValid = false;
         $('#msg_name').html('Please fill a valid name').show();
       }else{
         $('#msg_name').html('').hide();
       }
       ...
       if(!address && address.length <= 0){
         isValid = false;
         $('#msg_address').html('Please fill a valid address').show();
       }else{
       ...
       if(!landmark && landmark.length <= 0){
         isValid = false;
         $('#msg_landmark').html('Please fill a valid Landmark').show();
       }else{
         $('#msg_landmark').html('').hide();
       }
	   var pincode = $('#pincode').val();
       if(!pincode && pincode.length <= 0){
         isValid = false;
         $('#msg_pin').html('Please fill a valid Pincode').show();
       }else{
         $('#msg_pin').html('').hide();
       }
	   var phone = $('#phone').val();
       ...
       if(! pattern.test(phone)){
         ...
         isValid = false;
         $('#msg_phone').html('Please fill a valid Mobile No').show();
       }else{
         $('#msg_phone').html('').hide();
       }
       return isValid;
...
<!--Home Page Starts-->
<link href="<?php echo BASE_PATH_FRONT;?>theme_files/css/js-image-slider.css" rel="stylesheet" type="text/css">
...
//3-june
if($pagename=='product_list_brand') { echo $product_list_brand; }
//31-july
if($pagename=='product_list_search') { echo $product_list_search; }
...
<?php /*?><a href="<?php echo BASE_URL.'cmscontaint/footerpages/aboutus/'?> ">About Us </a> | 
<a href="<?php echo BASE_URL.'cmscontaint/footerpages/contactus/'?>">Contact Us</a> | 
<a href="#">Fashion Accessories</a> | <a href="#">Jewellery</a> | <a href="#">Watches</a> | <a href="#">Mobiles</a> | <a href="#">Computer &amp; Spare Parts</a> | <a href="#">Camera &amp; Accessories</a> | <a href="#">Electronics</a> | <a href="#">Gifts</a> | <a href="#">FMCG</a> | <a href="#">Car &amp; Byke</a> | <a href="#">Television</a><?php */?>
