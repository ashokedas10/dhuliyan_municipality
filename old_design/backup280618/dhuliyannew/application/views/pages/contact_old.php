 <div class="main">
      ...
      <div class="span3 bs-docs-sidebar">
        <ul class="nav nav-list bs-docs-sidenav">
          <li><a href="#1"><i class="icon-chevron-right"></i>CONTACT DETAILS</a></li>
          <li><a href="#2"><i class="icon-chevron-right"></i>TRAVELING MAP</a></li>
          <li><a href="#3"><i class="icon-chevron-right"></i>CONTACT FORM</a></li>
        </ul>
      </div>
      <div class="span9">

        <section id="1">
		<div class="page-header"><h3>CONTACT DETAILS</h3></div>		
				 
				 <table  border="0">
				  <tr>
					<td width="146"><img src="<?php echo BASE_PATH_FRONT;?>theme_files/contactus.jpg" alt="" width="130" height="130" /></td>
					<td width="519">
				    <h3>Dhuliyan Municipality</h3>
				    <pre class="prettyprint linenums">Phone No :03485- 266133<br />Fax No   :03485 - 265233<br />Mail Id  : dhuliyanmunicipality@gmail.com<br />info@dhuliyanmunicipality.in<br /></pre></td>
				  </tr>
				</table>
		...
		<div class="page-header"><h3>TRAVEL MAP</h3></div>		
		 ...
		 <section id="3">
		<div class="page-header"><h3>CONTACT FORM</h3></div>		
...
<div style="width:430px; font-family:Verdana, Geneva, sans-serif; 
font-size:12px;padding:10px;" align="left">
