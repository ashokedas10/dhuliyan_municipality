...
<?php echo form_hidden('rid'.$i, $items['rowid']); ?>
	...
	<img src="<?php echo $picpath.$items['imagename']; ?>" alt="image" height="50" width="50" />	</td>
	
	    <td>
		<?php echo $items['name']; ?>
		<?php /*?><?php if ($this->cart->has_options($items['rowid']) == TRUE): ?>
	  ...
	  <td style="text-align:right">
	  <a href="<?php echo BASE_URL?>cmscontaint/removecart/<?php echo $items['rowid']; ?>">
	  <img src="<?php echo BASE_PATH_FRONT;?>theme_files/images/delete.png" height="30" width="30" />
	  </a>
	  </td>
	</tr>
