...
<?php
   ...
   <a href="<?php echo BASE_URL?>cmscontaint/product_details/home_page/<?php echo $row->id; ?>">
	...
	<?php $balance=($row->amount-$row->mrp); if($balance >0){?><spanx>
	<px style=" margin-top:20px; margin-left:5px; font:'Courier New', Courier, monospace; font-weight:bold;"><?php echo $balance; ?></px></spanx><?php } ?>
